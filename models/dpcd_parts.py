...
def log_feature(log_list, module_name, feature_name_list, img_name, module_output=True,scale_ratio=None):
    ...
    for k, log in enumerate(log_list):
        ...
        if module_output:
            ...
            log_dir = ph.vis_path + module_name + '/' + feature_name_list[k] + '/'
            Path(log_dir).mkdir(parents=True, exist_ok=True)
            log_equalize_dir = ph.vis_path + module_name + '/' + '{}'.format(scale_ratio) + '/' + feature_name_list[k] + '_equalize/'
            ...
            log_dir = ph.vis_path + module_name + '/'+ '{}'.format(scale_ratio) + '/' + feature_name_list[k] + '/'
            Path(log_dir).mkdir(parents=True, exist_ok=True)
